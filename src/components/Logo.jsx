...
export default function Logo({ variant = 'dark', onClick }) {
  return (
    <a href="/" className={`logo logo--${variant}`} onClick={onClick} aria-label="JBMJ & Associates LLP — Home">
      <span className="logo__mark" aria-hidden="true">
        <img src="/images/CA_india.png" alt="CA India" className="logo__icai-img" />
      </span>
